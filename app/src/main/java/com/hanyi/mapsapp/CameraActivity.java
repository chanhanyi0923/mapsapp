...
import com.hanyi.mapsapp.common.helpers.SnackbarHelper;
import com.hanyi.mapsapp.common.helpers.TapHelper;
import com.hanyi.mapsapp.common.helpers.TrackingStateHelper;
import com.hanyi.mapsapp.common.rendering.BackgroundRenderer;
import com.hanyi.mapsapp.common.rendering.ObjectRenderer;
import com.hanyi.mapsapp.common.rendering.ObjectRenderer.BlendMode;
import com.hanyi.mapsapp.common.rendering.PlaneRenderer;
import com.hanyi.mapsapp.common.rendering.PointCloudRenderer;
...
//        statusTextView = findViewById(R.id.text_view);
        ...
        arcoreSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
